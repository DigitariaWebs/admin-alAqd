...
export const metadata: Metadata = {
  title: 'Privacy Policy — Al-Aqd',
  description: 'Privacy Policy for the Al-Aqd application',
};
...
export default async function PrivacyPage({
  ...
  let doc = await LegalDocument.findOne({ type: 'privacy', language: lang }).lean();
  if (!doc && lang !== 'fr') {
    doc = await LegalDocument.findOne({ type: 'privacy', language: 'fr' }).lean();
  }
