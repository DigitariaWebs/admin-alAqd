 ...
 * GET /api/matches
 *
 * Returns paginated match history for the current user.
 * Every document in the Match collection represents a mutual match
 * (both parties liked each other).
 */
export async function GET(request: NextRequest) {
    try {
        ...
        // Collect the "other" user ID for each match
